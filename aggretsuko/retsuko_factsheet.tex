...
\NewDocumentCommand{\ally}{}{\def\card@bgcolor{green!30}}
\NewDocumentEnvironment{card}{m}{%
    ...
    \begin{tikzpicture}[x=1in,y=1in]
      ...
      \node at (1.25, 3) {\card@picture};
      \node[anchor=south east, inner sep=0.1in] at (2.5, 2.5) {\scalebox{4}{\card@occurence}};
      \node[%
        anchor=south west,%
        inner sep=0.1in,%
        draw,%
